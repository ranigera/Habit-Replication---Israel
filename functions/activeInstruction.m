...
%**************************************************************************
    ...
    function [] = Instructions_MP_7  (instrDisp, text, position, var)
        ...
        for ii = 1: length(squares)
            ...
            message = [1492 1512 1497 1489 1493 1506 32 1492 1494 1492 32 1492 1493 1500 1498 32 1506 1501 32 1492 1502 1511 1513 58 32 10 32 32 double(buttonX) 32 32 32]; % this needs to be modified to have it txt file with buttonX as wildcard
            %---
       ...
       DrawFormattedText(var.w, [1495 1509 32 1497 1502 1504 1497 32 45 32 1492 1502 1513 1498 44 32 1495 1509 32 1513 1502 1488 1500 1497 32 45 32 1495 1494 1493 1512 32 1508 1506 1501 32 1504 1493 1505 1508 1514 32], 'center', 'center', [0 0 0], 60); % this need to be put in a txt file with button X as wildcard
       Screen('Flip',var.w);
       %---
    ...
    function [] = Instructions_MP_8  (instrDisp, text, position, var)
        ...
        for ii = 1: length(squares)
            ...
            while ~correctPressed
                ...
                if (keyPressed == 1) && ismember(respKey, codeX)
                    ...
                    DrawFormattedText(var.w, [1504 1499 1493 1503 32], 'center', 'center', [0 120 0], 60);
                    Screen('Flip',var.w);
                    WaitSecs(2);
                    correctPressed = 1;
                ...
                elseif (keyPressed == 1) && ~ismember(respKey, codeX)
                    ...
                    DrawFormattedText(var.w, [1500 1488 32 1504 1499 1493 1503 46 32 1492 1514 1513 1493 1489 1492 32 1492 1504 1499 1493 1504 1492 32 1492 1497 1514 1492 32 10 32 32 32 double(num2str(buttonX)) 32 32 32 10 1504 1504 1505 1492 32 1513 1493 1489], 'center', 'center', [200 0 0], 60, false, false, 1.2); % this need to be put in a txt file with button X as wildcard
                    %---
                    Screen('Flip',var.w);
                    WaitSecs(2);
                    correctPressed = 0;
        ...
        DrawFormattedText(var.w, [1506 1489 1493 1491 1492 32 1496 1493 1489 1492 33 32 10 32 40 1495 1509 32 1497 1502 1504 1497 32 45 32 1492 1489 1488 41 32], 'center', 'center', [0 0 0], 60); % this need to be put in a txt file with button X as wildcard
        Screen('Flip',var.w);
        %---
    ...
    function [] = Instructions_MP_19 (instrDisp, text, position, var)
        ...
        text.restoractive = [1488 1501 32 1488 1514 47 1492 32 1495 1493 1513 1489 47 1514 32 1513 1494 1492 32 1494 1502 1503 32 1502 1504 1493 1495 1492 32 1500 1495 1510 47 1497 32 1506 1500 32 32 32 double(KbName(var.rightKey(1))) 32 32 10 1488 1501 32 1488 1514 47 1492 32 1495 1493 1513 1489 47 1514 32 1513 1494 1492 32 1494 1502 1503 32 1500 1514 1490 1493 1489 1493 1514 32 1500 1495 1510 47 1497 32 1506 1500 32 32 double(KbName(var.leftKey(1))) 32];
        %---
        ...
        conName   = {[1500 1514 1490 1493 1489 1493 1514]; [1502 1504 1493 1495 1492]};
        %---
        ...
        for ii = 1:length(condition)
            ...
            while ~correctPressed
                ...
                if (keyPressed == 1) && ismember(respKey, codeX) % correct
                    ...
                    DrawFormattedText(var.w, [1504 1499 1493 1503 32], 'center', var.yLowerLow, [0 120 0], 60); % explain text
                    %---
                    Screen('Flip',var.w);
                ...
                elseif (keyPressed == 1) && ~ismember(respKey, codeX)
                    ...
                    DrawFormattedText(var.w, [1500 1488 32 1504 1499 1493 1503 46 32 1494 1492 1493 32 1494 1502 1503 32 32 32 conNameX 32 32 32 10 1504 1504 1505 1492 32 1513 1493 1489], 'center', var.yLowerLow, [200 0 0], 60,false, false, 1.2); % explain text
                    %---
                    Screen('Flip',var.w);
        ...
        %---Rani
        %DrawFormattedText(var.w, ' Good job! \n (right arrow next)  ', 'center', 'center', [0 0 0], 60); % this need to be put in a txt file with button X as wildcard
        DrawFormattedText(var.w, [32 1506 1489 1493 1491 1492 32 1496 1493 1489 1492 33 32 10 32 40 1495 1509 32 1497 1502 1504 1497 32 45 32 1492 1489 1488 41 32 32], 'center', 'center', [0 0 0], 60); % this need to be put in a txt file with button X as wildcard
        %---
        Screen('Flip',var.w);
