...
% UPDATE: Load different images according to the country the task is run in (to adapt the food items to the local preferences)

% added new images in the images folder
...
the recoding for the contingecies has been fixed (condition was not properly randomized)
